...
enum _sp {
	...
	SP_ADD_HEAL_RATE,SP_ADD_HEAL2_RATE,SP_ABSORB_DMG_MAXHP,SP_CRITICAL_LONG,SP_NO_WALKDELAY,SP_COOLDOWNRATE, //1090-1095
	...
	SP_MAGIC_ADDRACE2,SP_NO_MAGIC_GEAR_FUEL,SP_SKILL_DELAY,SP_REGEN_PERCENT_HP,SP_REGEN_PERCENT_SP //2081-2085
};
