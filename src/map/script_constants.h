...
#define _SCRIPT_CONSTANTS_H_
	...
	script_set_constant("killedrid_x",SP_KILLEDRID_X,true);
	script_set_constant("killedrid_y",SP_KILLEDRID_Y,true);
	...
	script_set_constant("bAddDefEle",SP_ADDDEF_ELE,false);
	...
	script_set_constant("bMagicAddDefEle",SP_MAGIC_ADDDEF_ELE,false);
	...
	script_set_constant("bIgnoreMdefClass",SP_IGNORE_MDEF_CLASS,false);
	...
	export_constant(LOOK_COSTUMEBODY);
	...
	script_set_constant("Eff_Freezing",SC_FREEZING,false);
	script_set_constant("Eff_Crystalize",SC_CRYSTALIZE,false);
	script_set_constant("Eff_Voiceofsiren",SC_VOICEOFSIREN,false);
	script_set_constant("Eff_Deepsleep",SC_DEEPSLEEP,false);
	...
	export_constant(SC_NETHERWORLD_POSTDELAY);
	...
	export_constant(SC_FALLENEMPIRE);
	...
	export_constant(SC_SONIC_CLAW_POSTDELAY);
	export_constant(SC_SILVERVEIN_RUSH_POSTDELAY);
	export_constant(SC_MIDNIGHT_FRENZY_POSTDELAY);
	export_constant(SC_TINDER_BREAKER_POSTDELAY);
	export_constant(SC_CBC_POSTDELAY);
	...
	export_constant(SC_DEFSET_NUM);
	export_constant(SC_MDEFSET_NUM);
	...
	export_constant(SC_MDEFSET_PER);
	...
	export_constant(SC_TELEPORT_FIXEDCASTINGDELAY);
	...
	export_constant(SI_LEXAETERNA);
	export_constant(SI_ADRENALINE);
	export_constant(SI_WEAPONPERFECT);
	export_constant(SI_OVERTHRUST);
	export_constant(SI_MAXIMIZE);
	export_constant(SI_RIDING);
	export_constant(SI_FALCON);
	export_constant(SI_TRICKDEAD);
	export_constant(SI_SHOUT);
	export_constant(SI_ENERGYCOAT);
	export_constant(SI_BROKENARMOR);
	export_constant(SI_BROKENWEAPON);
	export_constant(SI_ILLUSION);
	export_constant(SI_WEIGHTOVER50);
	export_constant(SI_WEIGHTOVER90);
	export_constant(SI_ATTHASTE_POTION1);
	export_constant(SI_ATTHASTE_POTION2);
	export_constant(SI_ATTHASTE_POTION3);
	export_constant(SI_ATTHASTE_INFINITY);
	export_constant(SI_MOVHASTE_POTION);
	...
	export_constant(SI_POSTDELAY);
	export_constant(SI_NOACTION);
	export_constant(SI_IMPOSSIBLEPICKUP);
	export_constant(SI_BARRIER);
	export_constant(SI_NOEQUIPWEAPON);
	export_constant(SI_NOEQUIPSHIELD);
	export_constant(SI_NOEQUIPARMOR);
	export_constant(SI_NOEQUIPHELM);
	export_constant(SI_PROTECTWEAPON);
	export_constant(SI_PROTECTSHIELD);
	export_constant(SI_PROTECTARMOR);
	export_constant(SI_PROTECTHELM);
	...
	export_constant(SI_PROPERTYFIRE);
	export_constant(SI_PROPERTYWATER);
	export_constant(SI_PROPERTYWIND);
	export_constant(SI_PROPERTYGROUND);
	export_constant(SI_MAGICATTACK);
	export_constant(SI_STOP);
	export_constant(SI_WEAPONBRAKER);
	export_constant(SI_PROPERTYUNDEAD);
	...
	export_constant(SI_LKCONCENTRATION);
	...
	export_constant(SI_GROUNDMAGIC);
	...
	export_constant(SI_SWORDREJECT);
	export_constant(SI_MARIONETTE_MASTER);
	export_constant(SI_MARIONETTE);
	export_constant(SI_MOON);
	export_constant(SI_BLOODING);
	...
	export_constant(SI_TING);
	export_constant(SI_STORMKICK_ON);
	export_constant(SI_STORMKICK_READY);
	export_constant(SI_DOWNKICK_ON);
	export_constant(SI_DOWNKICK_READY);
	export_constant(SI_TURNKICK_ON);
	export_constant(SI_TURNKICK_READY);
	export_constant(SI_COUNTER_ON);
	export_constant(SI_COUNTER_READY);
	export_constant(SI_DODGE_ON);
	export_constant(SI_DODGE_READY);
	export_constant(SI_STRUP);
	export_constant(SI_PROPERTYDARK);
	export_constant(SI_ADRENALINE2);
	export_constant(SI_PROPERTYTELEKINESIS);
	export_constant(SI_SOULLINK);
	export_constant(SI_PLUSATTACKPOWER);
	export_constant(SI_PLUSMAGICPOWER);
	export_constant(SI_DEVIL1);
	...
	export_constant(SI_SMA_READY);
	export_constant(SI_SKE);
	export_constant(SI_ONEHANDQUICKEN);
	export_constant(SI_FRIEND);
	export_constant(SI_FRIENDUP);
	export_constant(SI_SG_WARM);
	export_constant(SI_SG_SUN_WARM);
	export_constant(SI_SG_MOON_WARM);
	export_constant(SI_SG_STAR_WARM);
	...
	export_constant(SI_CLAIRVOYANCE);
	export_constant(SI_MOVESLOW_POTION);
	export_constant(SI_DOUBLECASTING);
	export_constant(SI_GRAVITATION);
	export_constant(SI_OVERTHRUSTMAX);
	export_constant(SI_LONGING);
	export_constant(SI_HERMODE);
	export_constant(SI_TAROTCARD);
	...
	export_constant(SI_CR_SHRINK);
	export_constant(SI_WZ_SIGHTBLASTER);
	export_constant(SI_DC_WINKCHARM);
	export_constant(SI_RG_CCONFINE_M);
	export_constant(SI_RG_CCONFINE_S);
	export_constant(SI_DISABLEMOVE);
	export_constant(SI_GS_MADNESSCANCEL);
	export_constant(SI_GS_GATLINGFEVER);
	export_constant(SI_EARTHSCROLL);
	export_constant(SI_NJ_UTSUSEMI);
	export_constant(SI_NJ_BUNSINJYUTSU);
	export_constant(SI_NJ_NEN);
	export_constant(SI_GS_ADJUSTMENT);
	export_constant(SI_GS_ACCURACY);
	...
	export_constant(SI_FOOD_STR);
	export_constant(SI_FOOD_AGI);
	export_constant(SI_FOOD_VIT);
	export_constant(SI_FOOD_DEX);
	export_constant(SI_FOOD_INT);
	export_constant(SI_FOOD_LUK);
	export_constant(SI_FOOD_BASICAVOIDANCE);
	export_constant(SI_FOOD_BASICHIT);
	export_constant(SI_FOOD_CRITICALSUCCESSVALUE);
	export_constant(SI_CASH_PLUSEXP);
	export_constant(SI_CASH_DEATHPENALTY);
	export_constant(SI_CASH_RECEIVEITEM);
	export_constant(SI_CASH_BOSS_ALARM);
	...
	export_constant(SI_MER_FLEE);
	export_constant(SI_MER_ATK);
	export_constant(SI_MER_HP);
	export_constant(SI_MER_SP);
	export_constant(SI_MER_HIT);
	...
	export_constant(SI_PROTECT_DEF);
	export_constant(SI_PROTECT_MDEF);
	export_constant(SI_HEALPLUS);
	...
	export_constant(SI_SUMMON1);
	export_constant(SI_SUMMON2);
	export_constant(SI_SUMMON3);
	export_constant(SI_SUMMON4);
	export_constant(SI_SUMMON5);
	...
	export_constant(SI_SWING);
	export_constant(SI_SYMPHONY_LOVE);
	export_constant(SI_PROPERTYWALK);
	export_constant(SI_SPELLFIST);
	export_constant(SI_NETHERWORLD);
	export_constant(SI_SIREN);
	export_constant(SI_DEEP_SLEEP);
	export_constant(SI_SIRCLEOFNATURE);
	export_constant(SI_COLD);
	export_constant(SI_GLOOMYDAY);
	export_constant(SI_SONG_OF_MANA);
	export_constant(SI_CLOUD_KILL);
	export_constant(SI_DANCE_WITH_WUG);
	export_constant(SI_RUSH_WINDMILL);
	export_constant(SI_ECHOSONG);
	export_constant(SI_HARMONIZE);
	export_constant(SI_STRIKING);
	export_constant(SI_WARMER);
	export_constant(SI_MOONLIT_SERENADE);
	export_constant(SI_SATURDAY_NIGHT_FEVER);
	export_constant(SI_SITDOWN_FORCE);
	export_constant(SI_ANALYZE);
	export_constant(SI_LERADS_DEW);
	export_constant(SI_MELODYOFSINK);
	export_constant(SI_BEYOND_OF_WARCRY);
	export_constant(SI_UNLIMITED_HUMMING_VOICE);
	...
	export_constant(SI_THORNS_TRAP);
	export_constant(SI_BLOOD_SUCKER);
	...
	export_constant(SI_AB_SECRAMENT);
	...
	/* Status change flags */
	export_constant(SCFLAG_NONE);
	export_constant(SCFLAG_NOAVOID);
	export_constant(SCFLAG_FIXEDTICK);
	export_constant(SCFLAG_LOADED);
	export_constant(SCFLAG_FIXEDRATE);
	export_constant(SCFLAG_NOICON);
	...
	export_constant(UMOB_ATK1);
	export_constant(UMOB_ATK2);
	...
	export_constant(UHOM_ATK1);
	export_constant(UHOM_ATK2);
	...
	export_constant(UPET_ATK1);
	export_constant(UPET_ATK2);
	...
	export_constant(UMER_ATK1);
	export_constant(UMER_ATK2);
	...
	export_constant(UELE_ATK1);
	export_constant(UELE_ATK2);
	...
	export_constant(UNPC_ATK1);
	export_constant(UNPC_ATK2);
