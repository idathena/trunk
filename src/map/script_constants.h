...
#define _SCRIPT_CONSTANTS_H_
	...
	#define export_constant2(a,b) script_set_constant(a,b,false)
	#define export_constant_offset(a,offset) script_set_constant(#a + (offset),a,false)
	#define export_parameter(a,b) script_set_constant(a,b,true)
	...
	export_constant2("bAddDefEle",SP_ADDDEF_ELE);
	...
	export_constant2("bMagicAddDefEle",SP_MAGIC_ADDDEF_ELE);
	...
	export_constant2("Eff_Voiceofsiren",SC_VOICEOFSIREN);
