...
# (Z) Merged Items, Roulette Lotter(Y)
...
CREATE TABLE IF NOT EXISTS `picklog` (
  ...
  `type` enum('M','P','L','T','V','S','N','C','A','R','G','E','B','O','I','X','D','U','$','F','Z','Y') NOT NULL default 'P',
...
#ChatLog types Gl(O)bal,(W)hisper,(P)arty,(G)uild,(M)ain chat,(C)lan chat
#Database: ragnarok
#Table: chatlog
